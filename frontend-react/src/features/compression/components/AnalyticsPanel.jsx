...
export const AnalyticsPanel = ({ item, totalOriginal, totalOptimized, savings }) => {
  ...
  return (
    <section className="glass-card h-full min-h-[420px] rounded-2xl border border-border/60 p-5">
      ...
      <div className="mt-4 grid gap-3 sm:grid-cols-2">
        <div className="min-h-[120px] rounded-xl border border-border/60 bg-muted/20 p-4">
      ...
      <div className="mt-4 rounded-xl border border-border/60 bg-gradient-to-br from-emerald-400/10 via-transparent to-transparent p-4">
